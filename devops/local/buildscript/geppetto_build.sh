...
DESKTOPCODE='../../../application/client/desktop/onemore_0354'
DESKTOPIMAGENAME='geppettotest/onemore_0354-desktop:1.0'
...
helm install --name onemore_0354 ./helm
if [ $? -eq 0 ]; then
